...
exports.compositeQueue = exports.getJobStatus = exports.queueCompositeGeneration = void 0;
...
let compositeQueue = null;
exports.compositeQueue = compositeQueue;
if (process.env.USE_QUEUE === 'true') {
    // Create Bull queue for composite image generation
    exports.compositeQueue = compositeQueue = new bull_1.default('composite-images', {
        redis: {
        ...
        try {
            ...
            if (!product.specialConfig) {
                product.specialConfig = {
                    components: [],
                    compositeMode: types_1.CompositeMode.AUTO,
                    combinationImages: []
                };
            }
            if (product.specialConfig) {
...
const queueCompositeGeneration = async (productId, mapping) => {
    if (!compositeQueue) {
        logger_1.default.warn('Queue is disabled. Cannot generate composite image.');
        return null;
    }
...
exports.default = compositeQueue;
